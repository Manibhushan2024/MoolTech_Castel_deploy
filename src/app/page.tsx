    ...
    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4 text-lg leading-relaxed">
                With over 10 years of excellence in vertical transportation,
                CastleElevator has become India&apos;s most trusted name in
                elevator solutions. We specialize in providing safe, reliable,
                and modern elevator systems for residential, commercial, and
                industrial buildings.
              </p>

              <p className="text-gray-600 dark:text-gray-400 mb-4 text-lg leading-relaxed">
                Our team of 50+ certified engineers and technicians is dedicated
                to delivering excellence in every project. We have successfully
                installed and maintained elevators in 500+ buildings, serving
                millions of people daily across Delhi, UP, Punjab, Jammu,
                Haryana, and Madhya Pradesh.
              </p>

              <p className="text-gray-600 dark:text-gray-400 mb-6 text-lg leading-relaxed">
                At CastleElevator, we are committed to the highest safety
                standards, innovative technology, and exceptional customer
                service. Whether it&apos;s a new installation, routine
                maintenance, or emergency support, we ensure your elevators run
                smoothly 24/7.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              From installation to maintenance, we offer comprehensive elevator
              solutions tailored to your building&apos;s needs. Our services
              ensure maximum uptime and safety for your property.
            </p>
          </div>
      ...
      <section className="py-16 bg-white dark:bg-gray-950">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              CastleElevator offers a wide range of premium elevator products
              designed for modern buildings. Each product is engineered for
            ...
            {products.map((product, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`relative h-44 w-full bg-gradient-to-br ${gradient} flex items-center justify-center overflow-hidden`}
                  >
                    {/* Animated Background Pattern */}
                    <div className="absolute inset-0 opacity-20">
                      <div className="absolute top-4 left-4 w-20 h-20 border-2 border-white rounded-full animate-pulse"></div>
                      <div
                        className="absolute bottom-4 right-4 w-16 h-16 border-2 border-white rounded-lg rotate-45 animate-pulse"
                  ...
                  {/* Bottom Accent Line */}
                  <div
                    className={`h-1 bg-gradient-to-r ${gradient} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left`}
                  ></div>
                </Link>
              )
            })}
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4 text-gray-900 dark:text-white">
              Why Choose CastleElevator?
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              With industry certifications, experienced engineers, and proven
              track record, we&apos;re the most trusted elevator partner in
              North India.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              ...
              clients across North India have to say about CastleElevator.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <details className="bg-white dark:bg-gray-800 rounded-lg p-6 cursor-pointer group shadow-md">
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                performance and safety. This ensures early detection of
                potential issues and extends the lifespan of your elevator
                system.
              </p>
            </details>
            ...
            <details className="bg-white dark:bg-gray-800 rounded-lg p-6 cursor-pointer group shadow-md">
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                Our emergency team responds within 2 hours in most areas. We
                provide 24/7 support with immediate phone guidance and rapid
                technician dispatch for critical situations.
              </p>
            </details>
            ...
            <details className="bg-white dark:bg-gray-800 rounded-lg p-6 cursor-pointer group shadow-md">
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                Yes! We provide complete elevator installation services with
                professional engineering, all necessary certifications,
                compliance checks, and comprehensive training for your staff.
              </p>
            </details>
            ...
            <details className="bg-white dark:bg-gray-800 rounded-lg p-6 cursor-pointer group shadow-md">
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                with professional installation, maintenance, and emergency
                support services.
              </p>
            </details>
            ...
            <details className="bg-white dark:bg-gray-800 rounded-lg p-6 cursor-pointer group shadow-md">
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                We provide comprehensive 5-year warranties on installations
                covering all parts and labor. Maintenance contracts include
                safety compliance guarantees and annual maintenance included.
              </p>
            </details>
            ...
            <details className="bg-white dark:bg-gray-800 rounded-lg p-6 cursor-pointer group shadow-md">
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-400 leading-relaxed">
                Absolutely! Our modernization services upgrade outdated systems
                with modern technology, improved safety features, energy
                efficiency improvements, and reduced maintenance requirements.
              </p>
            </details>
          </div>
        </div>
      ...
      <section className="bg-linear-to-r from-blue-600 to-blue-800 dark:from-blue-800 dark:to-blue-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
            Join 500+ satisfied clients across North India who trust
            CastleElevator for their vertical transportation needs. Get a free
            consultation from our expert team today.
          </p>
